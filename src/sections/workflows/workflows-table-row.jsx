...
export function WorkflowsTableRow({ row, selected, onSelectRow, onDeleteRow }) {
    ...
    <>
      ...
      >
        ...
        <TableCell align="right" sx={{ px: 1, whiteSpace: 'nowrap' }}>
          <Checkbox
            ...
            checkedIcon={<Iconify icon="eva:eye-fill" />}
      ...
      >
        <MenuList>
          ...
          >
            <img
              src="/assets/icons/platforms/6.svg"
              alt="States Icon"
          ...
          >
            <img
              src="/assets/icons/platforms/3.svg"
              alt="Workflow Documents Icon"
              style={{ width: 20, height: 20, marginRight: 8 }}
            />
            Workflow Documents
          </MenuItem>
