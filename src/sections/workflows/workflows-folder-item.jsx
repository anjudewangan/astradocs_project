...
import { WorkflowsFileDetails } from './workflows-file-details';
import { WorkflowsNewFolderDialog } from './workflows-new-folder-dialog';

// ----------------------------------------------------------------------

export function WorkflowsFolderItem({ sx, folder, selected, onSelect, onDelete, ...other }) {
