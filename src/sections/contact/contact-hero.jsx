...
const CONTACTS = [
  { country: 'Email', address: 'info@astradocs.in' },
  {
    country: 'Phone',
    address: '+91-7714915561',
  },
  {
    country: 'Office Address',
    address:
      '408, 4th Floor, Wallfort Ozone, Fafadih, Chowk, Raipur - Bilaspur Expy, Fafadih, Raipur, Chhattisgarh 492001',
  },
  {
    country: 'Business Hours',
    address: 'Monday to Saturday 10:00 AM - 7:00 PM',
  },
];
      ...
      <Container component={MotionContainer}>
        ...
        >
          <AnimateText
            component="h1"
            variant="h1"
            text={['Contact Us', 'Reach out to Astradocs']}
