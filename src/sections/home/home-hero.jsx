...
export function HomeHero({ sx, ...other }) {
  ...
  const renderHeading = (
    <AnimatedDiv>
      ...
      >
        ...
        >
          <span
            style={{ fontFamily: 'Samarkan, sans-serif', fontWeight: 'bold', color: '#fca311' }}
          >
          Astradocs 
          </span>
        </Box>
  ...
  const renderText = (
    <AnimatedDiv>
      ...
      >
        {`Revolutionize your approach to handling documents with our cutting-edge platform. \nExplore a seamless blend of advanced features, a user-friendly interface, and robust security.`}
      </Typography>
    </AnimatedDiv>
  );
  ...
  const icons = [
    { key: 'file-management', label: 'File Management' },
    { key: 'file-settings', label: 'File Settings' },
    { key: 'file-security', label: 'File Security' },
          ...
          <AnimatedDiv key={key}>
            ...
            >
              <Box
                component="img"
                alt={key}
                src={`${CONFIG.assetsDir}/assets/icons/platforms/ic-${key}.svg`}
