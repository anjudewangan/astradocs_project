...
import { PlanFreeIcon, PlanStarterIcon, PlanPremiumIcon, PlanEnterpriseIcon } from 'src/assets/icons';  
...
export function PricingCard({ card, sx, ...other }) {
  ...
  const basic = subscription === 'free trial';
  const starter = subscription === 'starter';
  const premium = subscription === 'professional';
  ...
  const renderIcon = (
    <Stack direction="row" alignItems="center" justifyContent="space-between">
      ...
      {enterprise && <PlanEnterpriseIcon sx={{ width: 64 }} />}  
