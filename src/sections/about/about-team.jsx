      ...
      <Container component={MotionViewport} sx={{ textAlign: 'center', py: { xs: 10, md: 15 } }}>
        ...
        <m.div variants={varFade().inUp}>
          <Typography sx={{ mx: 'auto', maxWidth: 640, color: 'text.secondary' }}>
            Get to know the faces behind Astradocs. Our diverse team of experts brings together a
            wealth of experience and a shared commitment to revolutionizing document management.
          </Typography>
        </m.div>
