          ...
          methods={[
            {
              ...
              icon: `${CONFIG.assetsDir}/assets/icons/platforms/1.svg`,
            },
            {
              label: 'Firebase',
              path: paths.auth.firebase.signIn,
              icon: `${CONFIG.assetsDir}/assets/icons/platforms/2.svg`,
            },
            {
              label: 'Jwt',
              path: paths.auth.jwt.signIn,
              icon: `${CONFIG.assetsDir}/assets/icons/platforms/3.svg`,
            },
            {
              label: 'Auth0',
            ...
            },
            {
              ...
              icon: `${CONFIG.assetsDir}/assets/icons/platforms/6.svg`,
            },
          ]}
        />
