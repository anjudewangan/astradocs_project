...
const ICONS = {
  ...
  workflow: icon('ic-workflow'),
  cabinet: icon('ic-cabinet'),
    ...
    items: [
      {
        ...
        icon: ICONS.file,
        children: [
          { title: 'All Documents', path: paths.dashboard.fileManager },
          { title: 'Recently Accessed', path: paths.dashboard.user.root },
          { title: 'Recently Created', path: paths.dashboard.user.cards },
          { title: 'Favorites', path: paths.dashboard.user.list },
          { title: 'Trash Can', path: paths.dashboard.user.demo.edit },
          { title: 'Duplicated Documents', path: paths.dashboard.user.demo.edit },
          { title: 'New Document', path: paths.dashboard.user.account },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: ICONS.calendar,
        children: [
          { title: 'All', path: paths.dashboard.product.demo.details },
          { title: 'Create Cabinet', path: paths.dashboard.product.new },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: ICONS.label,
        children: [
          { title: 'All', path: paths.dashboard.user.list },
          { title: 'Create New Tag', path: paths.dashboard.job.demo.details },
        ],
      },
    ],
  },
